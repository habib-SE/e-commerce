              ...
              <Dialog.Panel className=" relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                        ...
                        <Tab
                          ...
                          className={({ selected }) =>
                            classNames(
                              ...
                              "flex-1 whitespace-nowrap border-b-2 px-2 py-4 text-base font-medium border-none"
                            )
                          }
                        >
                          {category.name}
                ...
                <div className=" border-t border-gray-200 px-4 py-6">
                  <a href="/" className=" -m-2 flex items-center p-2">
                    <img
                      src="https://tailwindui.com/img/flags/flag-cavada.svg"
                      alt=""
            ...
            <div className=" flex h-16 items-center px-11">
              ...
              <div className=" ml-auto flex items-center">
                  ...
                  {true ? (
                    <div>
                      <Avatar
                        ...
                        aria-haspopup="true"
                        aria-expanded={open ? "true" : undefined} //onClick = {handelUserClick}
                        sx={{
                      ...
                      <Menu
                        ...
                        anchorEl={anchorE1}
                        open={openUserMenu}
                        onClose={handleCloseUserUserMenu}
                        MenuListProps={{
                ...
                <div className=" flex lg:ml-6">
                  <p className=" pt-2 text-gray-400 hover:text-gray-500">
